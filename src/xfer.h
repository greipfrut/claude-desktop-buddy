...
// Battery monitor abstraction defined in main.cpp. Waveshare S3 Touch 2.8
// lacks an AXP192 — battery is read via ADC on PIN_BAT through a divider,
// USB presence via a GPIO. main.cpp owns the driver; xfer.h just reads.
int   batteryPercent();
int   batteryMilliVolts();
int   batteryMilliAmps();
bool  batteryUsbPresent();
int   batteryUsbMilliVolts();
